...
export default function RecipeCardMenu(props: RecipeCardMenuProps) {
    ...
    const [acceptDialogState, setAcceptDialogState] = useState<AlertDialogState>({ open: false });
    ...
    return (
        <div>
            ...
            >
                <MenuItem >
                    <Link style={{ textDecoration: 'none' }} href={`/editForm/${props.recipeId}`}><EditIcon />Edit</Link>
                </MenuItem>
                <MenuItem onClick={
                    () => {
                        handleClose();
                        setAcceptDialogState({ text: "Do you really want to delete this Recipe?", open: true });
                    }}
                >
                    <DeleteIcon />Delete
                    </MenuItem>
            ...
            <AcceptDialog alertDialogState={acceptDialogState}
                onCancel={() => {
